...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('complements', function (Blueprint $table) {
            ...
            $table->enum('type', ['globos', 'peluches', 'chocolates']); // Tipos de complementos
            $table->string('color')->nullable();
            $table->string('size')->nullable(); // Para peluches y globos
            $table->string('brand')->nullable(); // Para chocolates
